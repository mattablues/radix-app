...
{% block body %}
    <section>
      ...
      <div class="mt-8 flex justify-center md:justify-start">
        <a href="/api/v1/health" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 bg-slate-800 text-white text-sm font-semibold rounded-lg hover:bg-slate-900 transition-all shadow-md shadow-slate-200">
