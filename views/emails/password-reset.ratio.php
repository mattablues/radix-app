...
{% block title %}Återställ ditt lösenord{% endblock %}
...
{% block body %}
  ...
  <p class="body-text" style="margin:0 0 12px 0; color:#111827; line-height:1.45;">
    Vi har fått en begäran om att återställa ditt lösenord. Klicka på knappen nedan för att välja ett nytt.
  </p>
  ...
  <p class="muted muted-small" style="margin-top:16px; font-size:12px; color:#6B7280;">Begärt {{ date('Y-m-d H:i') }}</p>
{% endblock %}