  ...
  <main class="grow flex items-center justify-center p-6 relative overflow-hidden">
    ...
    <div class="max-w-md w-full text-center">
      <div class="relative mb-8">
        <span class="text-[140px] font-black text-slate-200/60 select-none leading-none tracking-tighter">413</span>
        <div class="absolute inset-0 flex items-center justify-center pt-8">
            <h1 class="text-2xl font-black text-slate-800 uppercase tracking-[0.2em]">Payload limit</h1>
        </div>
      </div>

      <div class="bg-white border border-gray-100 p-10 rounded-[2.5rem] shadow-2xl shadow-blue-900/5 relative z-10">
        <h2 class="text-lg font-bold text-gray-900 mb-3 uppercase tracking-wide">Dataöverföringen avbröts</h2>
        <p class="text-sm text-slate-500 mb-10 leading-relaxed">
          Den skickade begäran överskrider systemets definierade storleksgräns (Content-Length). Vänligen komprimera filen eller dela upp begäran i mindre delar.
        </p>

        <div class="flex flex-col gap-4">
            <a href="javascript:history.back()" class="inline-flex items-center justify-center px-8 py-4 bg-blue-600 text-white text-xs font-black uppercase tracking-widest rounded-2xl shadow-lg shadow-blue-500/20 hover:bg-blue-700 transition-all active:scale-[0.98]">
                Gå tillbaka och åtgärda
            </a>
            <a href="<?= route('home.index') ?>" class="text-[10px] font-bold text-slate-400 hover:text-blue-600 uppercase tracking-widest transition-colors py-2">
                Avbryt och gå hem
            </a>
        </div>
      </div>
