  ...
  <header class="w-full bg-white border-b border-gray-200">
    <div class="container-centered mx-auto px-4 sm:px-6">
      <div class="h-16 flex justify-between items-center">
        ...
        <a href="<?= getenv('APP_URL') ?>" class="p-2 rounded-full text-slate-400 hover:text-indigo-600 hover:bg-slate-50 transition-all">
  ...
  <main class="grow flex items-center justify-center p-6">
    <div class="max-w-md w-full text-center">
      <div class="relative mb-4">
        <span class="text-[120px] font-black text-amber-50 select-none leading-none">403</span>
        <div class="absolute inset-0 flex items-center justify-center">
            <h1 class="text-3xl font-black text-slate-800 uppercase tracking-tight">Stopp där!</h1>
        </div>
      </div>

      <div class="bg-white border border-gray-200 p-8 rounded-2xl shadow-xl relative z-10">
        <h2 class="text-xl font-bold text-gray-900 mb-3">Åtkomst nekad</h2>
        <p class="text-slate-500 mb-8 leading-relaxed">
          Du har tyvärr inte behörighet att se den här sidan. Kontrollera att du är inloggad med ett konto som har rätt rättigheter.
        </p>

        <div class="flex flex-col gap-3">
            <a href="<?= getenv('APP_URL') ?>" class="inline-flex items-center justify-center px-6 py-3 bg-slate-800 text-white font-bold rounded-xl shadow-lg hover:bg-slate-900 transition-all active:scale-[0.98]">
                Gå till startsidan
            </a>
        </div>
      </div>
