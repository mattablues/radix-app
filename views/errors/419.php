...
<head>
  ...
  <title>419 - Session Expired | Radix</title>
  ...
  <main class="grow flex items-center justify-center p-6 relative overflow-hidden">
    ...
    <div class="max-w-md w-full text-center">
      <div class="relative mb-8">
        <span class="text-[140px] font-black text-slate-200/60 select-none leading-none tracking-tighter">419</span>
        <div class="absolute inset-0 flex items-center justify-center pt-8">
            <h1 class="text-2xl font-black text-slate-800 uppercase tracking-[0.2em]">Token expired</h1>
        </div>
      </div>

      <div class="bg-white border border-gray-100 p-10 rounded-[2.5rem] shadow-2xl shadow-blue-900/5 relative z-10">
        <h2 class="text-lg font-bold text-gray-900 mb-3 uppercase tracking-wide">Sessionen har löpt ut</h2>
        <p class="text-sm text-slate-500 mb-10 leading-relaxed">
          Säkerhets-token för denna begäran är inte längre giltig. Detta sker oftast när en sida lämnats inaktiv för länge. Vänligen uppdatera sessionen för att fortsätta.
        </p>
