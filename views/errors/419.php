...
<head>
  ...
  <title>419 - Sessionen har löpt ut</title>
...
<body class="bg-slate-50 text-slate-600 antialiased min-h-screen flex flex-col">
  ...
  <main class="grow flex items-center justify-center p-6">
    <div class="max-w-md w-full text-center">
      <div class="relative mb-4">
        <span class="text-[120px] font-black text-slate-200 select-none leading-none">419</span>
        <div class="absolute inset-0 flex items-center justify-center">
            <h1 class="text-3xl font-black text-slate-800 uppercase tracking-tight">Utgången!</h1>
        </div>
      </div>

      <div class="bg-white border border-gray-200 p-8 rounded-2xl shadow-xl relative z-10">
        <h2 class="text-xl font-bold text-gray-900 mb-3">Sessionen har löpt ut</h2>
        <p class="text-slate-500 mb-8 leading-relaxed">
          Sidan har varit inaktiv för länge av säkerhetsskäl. Prova att ladda om sidan och skicka formuläret igen.
        </p>

        <div class="flex flex-col gap-3">
            <button onclick="location.reload()" class="inline-flex items-center justify-center px-6 py-3 bg-indigo-600 text-white font-bold rounded-xl shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-all active:scale-[0.98] cursor-pointer">
  ...
  <footer class="py-8">
    <p class="text-xs text-slate-400 font-medium text-center tracking-wide">
