...
<body class="bg-slate-50 text-slate-600 antialiased min-h-screen flex flex-col">
  ...
  <!-- Header: Synkad med admin-layouten -->
  ...
  <main class="grow flex items-center justify-center p-6">
    <div class="max-w-md w-full text-center">
      <div class="relative mb-4">
        <span class="text-[120px] font-black text-slate-200 select-none leading-none">404</span>
        <div class="absolute inset-0 flex items-center justify-center">
            <h1 class="text-3xl font-black text-slate-800 uppercase tracking-tight">Hoppsan!</h1>
        </div>
      </div>

      <div class="bg-white border border-gray-200 p-8 rounded-2xl shadow-xl relative z-10">
        <h2 class="text-xl font-bold text-gray-900 mb-3">Sidan kunde inte hittas</h2>
        <p class="text-slate-500 mb-8 leading-relaxed">
          Det verkar som att sidan du letar efter har flyttat eller aldrig existerat. Kontrollera adressen eller gå tillbaka hem.
        </p>

        <div class="flex flex-col gap-3">
            <a href="<?= getenv('APP_URL') ?>" class="inline-flex items-center justify-center px-6 py-3 bg-indigo-600 text-white font-bold rounded-xl shadow-lg shadow-indigo-100 hover:bg-indigo-700 transition-all active:scale-[0.98]">
                Tillbaka till säker mark
            </a>
            <a href="javascript:history.back()" class="text-sm font-semibold text-slate-400 hover:text-slate-600 transition-colors py-2">
