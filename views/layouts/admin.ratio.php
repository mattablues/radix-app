  ...
  {% if($currentUser->hasAtLeast('moderator')) : %}
      <div class="pt-4 mt-4 border-t border-gray-800">
        ...
        <nav class="space-y-1">
          ...
          <!-- System Dropdown -->
          <div x-data="{ systemDropdown: {{ (strpos($pageId, 'admin-update') !== false || strpos($pageId, 'admin-event') !== false || strpos($pageId, 'admin-create') !== false || $pageId === 'health') ? 'true' : 'false' }} }">
            ...
            <ul x-show="systemDropdown" x-cloak x-collapse class="mt-1 ml-4 border-l border-gray-800 space-y-1">
              ...
              <!-- Systemuppdateringar -->
              <li>
                <a href="{{ route('admin.system-update.index') }}" class="block py-2 px-8 text-sm {{ ($pageId === 'admin-updates-index') ? 'text-indigo-400 font-bold' : 'text-gray-500 hover:text-gray-200' }}">
                  Uppdateringar
                </a>
              </li>
              <li>
                <a href="{{ route('admin.system-update.create') }}" class="block py-2 px-8 text-sm {{ ($pageId === 'admin-update-create') ? 'text-indigo-400 font-bold' : 'text-gray-500 hover:text-gray-200' }}">
                  Ny uppdatering
                </a>
              </li>
